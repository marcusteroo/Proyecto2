      ...
      <div class="card border-0 shadow-sm">
        <div class="card-body">
          ...
          <form @submit.prevent="submitForm">
            <!-- Campo ID Tarea (oculto) -->
            <input type="hidden" v-model="editedTarea.id_tarea">
...
const editedTarea = ref({
  id_tarea: '', // Añadido el campo id_tarea
  titulo: '',
  descripcion: '',
  estado: '',
  id_tablero: '' // Añadido el campo id_tablero
})
...
onMounted(async () => {
  try {
    ...
    editedTarea.value = {
      id_tarea: tarea.id_tarea || route.params.id,
      titulo: tarea.titulo || '',
